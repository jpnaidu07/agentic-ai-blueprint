...
class Agent2AgentBroker:
    ...
    def dispatch_agent_delegation(self, sender: str, target_agent: str, action: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        msg = AgentMessage(
            sender_agent=sender,
...
def tool_invoke_subagent(target_agent: str, action: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
