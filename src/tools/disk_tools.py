...
def tool_rag_search_runbook(query: str) -> Dict[str, Any]:
    ...
    return {
        "query": query,
        "matched_runbooks": results
    }

def tool_submit_service_ticket(server_id: str, component: str, priority: str = "CRITICAL", runbook_id: Optional[str] = None, idempotency_key: Optional[str] = None) -> Dict[str, Any]:
