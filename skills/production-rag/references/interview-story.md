...
- **Result:** working evidence-grounded baseline with repeatable tests and visible limitations; query-time local hybrid retrieval is implemented, while persistent vector ingestion and live quality evaluation remain a separate work package.
